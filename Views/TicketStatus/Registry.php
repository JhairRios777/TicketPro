        ...
        <div class="col-md-6">
            <div class="card-mb-grid">
                ...
                <div class="card-body collapse show">
                    <form id="ticketStatusForm" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input autocomplete="off" placeholder="Ej: Abierto, Cerrado" type="text" name="name" id="name" class="form-control" value="<?php echo $JData->name; ?>">
                        </div> <br>
                        
                        <div class="form-group">
                            <label for="description" class="form-label">Descripción</label>
                            <input autocomplete="off" placeholder="Ej: Estado que indica que el ticket está abierto o cerrado" rows="4" type="text" name="description" id="description" class="form-control" value="<?php echo $JData->description; ?>">
                        </div> <br>
...
(function(){
    ...
    form.addEventListener('submit', async function(e){
        ...
        if (!name) {
            await Swal.fire('Error', 'El campo Nombre del Estado es obligatorio.', 'error');
        ...
        const confirm = await Swal.fire({
            ...
            text: 'Se guardarán los datos del estado.',
            icon: 'question',
        ...
        try {
            ...
            if (res.ok) {
                const msg = data && data.message ? data.message : 'Estado guardado correctamente.';
                await Swal.fire('Éxito', msg, 'success');
                window.location.href = (data && data.redirect) ? data.redirect : '/TicketStatus';
            } else {
